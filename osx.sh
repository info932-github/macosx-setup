...
sudo scutil --set ComputerName "0x6A6C7731"
sudo scutil --set HostName "0x6A6C7731"
sudo scutil --set LocalHostName "0x6A6C7731"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "0x6A6C7731"
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" "Dock" "Finder" "Mail" "Messages" "Safari" "iCal"; do
